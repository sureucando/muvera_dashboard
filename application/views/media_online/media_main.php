			...
			<form id="search-form" name="search-form">
				<div class="section-search">
					...
					<div id="search-container">
						<input type="text" class="search-keyword search-keyword-main" placeholder="+ Add Word" name="main-word" value="ahok">
				...
				<div class="section-choice">
					<div class="btn-media-container">
						<div class="btn btn-media btn-media-md">
							<input id="Antara" type="checkbox" name="media[]" value="antaranews_data" checked="true">
							<label for="Antara">Antara</label>
						</div>
						<div class="btn btn-media btn-media-md">
							<input id="BeritaSatu" type="checkbox" name="media[]" value="beritasatu_data" checked="true">
							<label for="BeritaSatu">Berita Satu</label>
						</div>
						<div class="btn btn-media btn-media-md">
							<input id="CNNIdn" type="checkbox" name="media[]" value="cnnindo_data" checked="true">
							<label for="CNNIdn">CNN Idn</label>
						</div>
						<div class="btn btn-media btn-media-md">
							<input id="Detik" type="checkbox" name="media[]" value="detik_data" checked="true">
							<label for="Detik">Detik</label>
						</div>
						<div class="btn btn-media btn-media-md">
							<input id="Fajar" type="checkbox" name="media[]" value="fajar_data" checked="true">
							<label for="Fajar">Fajar</label>
						</div>
						<div class="btn btn-media btn-media-md">
							<input id="Jakarta Post" type="checkbox" name="media[]" value="jakpost_data" checked="true">
							<label for="Jakarta Post">Jakarta Post</label>
						</div>
						<div class="btn btn-media btn-media-md">
							<input id="JPNN" type="checkbox" name="media[]" value="jpnn_data" checked="true">
							<label for="JPNN">JPNN</label>
						</div>
						<div class="btn btn-media btn-media-md">
							<input id="Kompas" type="checkbox" name="media[]" value="kompas_data" checked="true">
							<label for="Kompas">Kompas</label>
						</div>
						<div class="btn btn-media btn-media-md">
							<input id="Liputan6" type="checkbox" name="media[]" value="liputan6_data" checked="true">
							<label for="Liputan6">Liputan6</label>
						</div>
						<div class="btn btn-media btn-media-md">
							<input id="Merdeka" type="checkbox" name="media[]" value="merdeka_data" checked="true">
							<label for="Merdeka">Merdeka</label>
						</div>
						<div class="btn btn-media btn-media-md">
							<input id="MetroTV" type="checkbox" name="media[]" value="metrotvnews_data" checked="true">
							<label for="MetroTV">Metro TV</label>
						</div>
						<div class="btn btn-media btn-media-md">
							<input id="PojokSatu" type="checkbox" name="media[]" value="pojoksatu_data" checked="true">
							<label for="PojokSatu">Pojok Satu</label>
						</div>
						<div class="btn btn-media btn-media-md">
							<input id="Republika" type="checkbox" name="media[]" value="republika_data" checked="true">
							<label for="Republika">Republika</label>
						</div>
						<div class="btn btn-media btn-media-md">
							<input id="Rima" type="checkbox" name="media[]" value="rimanews_data" checked="true">
							<label for="Rima">Rima</label>
						</div>
						<div class="btn btn-media btn-media-md">
							<input id="RMOL" type="checkbox" name="media[]" value="rmol_data" checked="true">
							<label for="RMOL">RMOL</label>
						</div>
						<div class="btn btn-media btn-media-md">
							<input id="Sindo" type="checkbox" name="media[]" value="sindonews_data" checked="true">
							<label for="Sindo">Sindo</label>
						</div>
						<div class="btn btn-media btn-media-md">
							<input id="Suara" type="checkbox" name="media[]" value="suara_data" checked="true">
							<label for="Suara">Suara</label>
						</div>
						<div class="btn btn-media btn-media-md">
							<input id="Tempo" type="checkbox" name="media[]" value="tempo_data" checked="true">
							<label for="Tempo">Tempo</label>
						</div>
						<div class="btn btn-media btn-media-md">
							<input id="TeropongSenayan" type="checkbox" name="media[]" value="teropongsenayan_data" checked="true">
							<label for="TeropongSenayan">Teropong Senayan</label>
						</div>
						<div class="btn btn-media btn-media-md">
							<input id="Tribun" type="checkbox" name="media[]" value="tribunnews_data" checked="true">
							<label for="Tribun">Tribun</label>
						</div>
						<div class="btn btn-media btn-media-md">
							<input id="Viva" type="checkbox" name="media[]" value="viva_data" checked="true">
